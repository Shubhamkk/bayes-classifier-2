                ...
                for test in range(nu_class):
                    ...
                    while(1):
                        ...
                        for j in range(k_cluster):
                            ...
                            if(d<0):
                                d=(-1)*d
                            inv=nm.linalg.inv(self.class_sigma_mean_mix[k][0][j])
                        ...
                        for j in range(k_cluster):
                            ...
                            if(d<0):
                                d=(-1)*d
                            inv=nm.linalg.inv(self.class_sigma_mean_mix[k+1][0][j])
                        ...
                        for j in range(k_cluster):
                            ...
                            if(d<0):
                                d=(-1)*d
                            inv=nm.linalg.inv(self.class_sigma_mean_mix[k+2][0][j])
