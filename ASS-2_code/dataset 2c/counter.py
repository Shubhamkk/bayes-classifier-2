    ...
    def counter_represent(self):
        ...
        while(1):
            ...
            if(t1==0):
                ...
                cl='brown'
                lb='Class3'
            plt.scatter(x,y,color=cl ,marker='*',s=0.000001,label=lb)
            ...
            for k in range(3):
                ...
                a1=nm.arange((u_0-150),(u_0 +150),0.1)
                a2=nm.arange((u_1-200),(u_1 +200),0.1)
                ...
                #for i in z:
                    #print (i)
                #if(k==2):
                plt.contour(x,y,z,5,colors=clr,label=lb,linnestyles='solid')
